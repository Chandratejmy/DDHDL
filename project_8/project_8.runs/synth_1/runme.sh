...
HD_PWD='C:/Users/ADMIN/Desktop/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stimulus_mux4_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stimulus_mux4_1.tcl
